...
\historychange{Extended debugging support. In case of JSON syntax errors the log file contains an extract of the JSON content nearby the position, where the error occurred.}
