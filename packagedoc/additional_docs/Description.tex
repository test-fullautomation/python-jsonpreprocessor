...
Either we give the JSON files the extension \pcode{.json}, then the editor expects a JSON file in standard syntax,
or we change the extension to \pcode{.jsonp}, but in this case an editor usualy does not know how to display a file of such type.
